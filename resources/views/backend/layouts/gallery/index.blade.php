            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('gallery.create') }}" class="btn btn-sm btn-success">Create New Service</a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($gallerys as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data -> name }}</td>
                                            <td>
                                                @foreach ( $data -> image   as $imgname)
                                                    <img src="{{ URL::to('') }}/backend/assets/img/gallery/{{$imgname -> imagename}}" alt="" style="width: 80px; height:80px;">
                                                @endforeach
