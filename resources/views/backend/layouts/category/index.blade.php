                                ...
                                <tbody>
                                    ...
                                    @foreach ($alldata as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data -> name }}</td>
                                            <td>{{ $data -> slug }}</td>
                                            <td><img src="{{ URL::to('') }}/backend/assets/img/category/{{ $data -> photo }}" alt=" "></td>
                                            <td>{{ $data -> created_at ->diffForHumans() }}</td>
                                            <td><a href="{{ route('categoryedit' ,$data -> id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a> <a href="{{ route('catedelete' ,$data -> id) }}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                    @endforeach
