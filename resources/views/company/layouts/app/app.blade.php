...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ URL::to('company/assets/img/favicon.png') }}" rel="icon">
  <link href="{{ URL::to('company/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
  ...
  <link href="{{ asset('company/assets/vendor/owl.carousel/company/assets/owl.carousel.min.css') }}" rel="stylesheet">
